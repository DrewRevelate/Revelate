...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative isolate z-0 flex h-full min-h-[100dvh] items-center justify-center overflow-hidden bg-navy text-white pt-36 sm:pt-40 md:pt-44 lg:pt-48 xl:pt-52 2xl:pt-56 pb-32"
    >
