                ...
                {packages.filter((p) => p.isFeatured).map((pkg, index) => {
                  ...
                  <motion.div
                    ...
                    className={`rounded-xl p-6 transition-all cursor-pointer ${
                      isExpanded
                        ? 'bg-[#00d9ff]/10 border-2 border-[#00d9ff] shadow-lg shadow-[#00d9ff]/20'
                        : 'bg-[#1a1f3a] border border-gray-700 hover:border-[#00d9ff]'
                    }`}
                  ...
                  >
                    ...
                    {pkg.tagline && <p className="text-sm text-gray-400 mb-3">{pkg.tagline}</p>}
                    <p className="text-gray-300 mb-4 text-sm">{pkg.shortDescription}</p>
                      ...
                      <div className="pt-4 border-t border-gray-700">
                        ...
                        <ul className="space-y-1">
                          {pkg.packageServices.slice(0, 3).map((ps) => (
                            <li key={ps.service.id} className="text-sm text-gray-300 flex items-start gap-2">
