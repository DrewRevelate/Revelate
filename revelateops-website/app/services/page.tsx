              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {packages.filter((p) => p.isFeatured).map((pkg, index) => {
                  ...
                  >
                    ...
                    {pkg.tagline && <p className="text-sm text-white/95 mb-3">{pkg.tagline}</p>}
                    <p className="text-white mb-4 text-sm">{pkg.shortDescription}</p>
                    ...
                    {pkg.packageServices && pkg.packageServices.length > 0 && (
                      <div className="pt-4 border-t border-white/10">
                        <p className="text-sm text-white/90 mb-2">Includes:</p>
